...
import type { Card as CardType, Column, BoardMemberRole, CardPriority, User, Label } from '@/types/database';
...
export function KanbanCard({
  ...
  const handlePriorityChangeAction = async (cardParam: CardType, newPriority: CardPriority) => {
    try {
