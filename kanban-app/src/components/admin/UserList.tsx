...
export function UserList({ boardId, currentUserRole, refreshTrigger, onUserAction }: UserListProps) {
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      <Badge className={getRoleBadgeClasses(user.role)} variant="outline">
