...
export function EditColumnDialog({
  ...
  const currentBoard = useAppState((state) => state.currentBoard);

  const { register, handleSubmit: rhfHandleSubmit, reset, formState: { errors } } = useForm<FormValues>({
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const existingColumn = currentBoard?.columns.find(col => col.id === column.id);
