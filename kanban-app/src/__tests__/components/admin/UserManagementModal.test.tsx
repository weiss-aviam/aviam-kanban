...
vi.mock('@/components/admin/MembershipTable', () => ({
  MembershipTable: ({ onMembershipAction }: { onMembershipAction: () => void }) => (
...
describe('UserManagementModal', () => {
  ...
  it('should render modal when open is true', () => {
    ...
    expect(screen.getByText('User Management - Test Board')).toBeInTheDocument();
  ...
  it('should not render modal when user is not admin', () => {
    ...
    expect(screen.queryByText('User Management - Test Board')).not.toBeInTheDocument();
  });
