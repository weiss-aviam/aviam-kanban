      ...
      <Card className="w-full max-w-md mx-auto">
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-sm">
            Get started by creating your first column. You can organize your
            tasks into different stages like &quot;To Do&quot;, &quot;In
            Progress&quot;, and &quot;Done&quot;.
          </p>
          <p className="text-sm text-gray-500">
            Use the &quot;Add Column&quot; button in the header to create your
            first column.
          </p>
        </CardContent>
      </Card>
    ...
    <div className="flex items-center justify-center h-full">
      <Card className="w-full max-w-md mx-auto">
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-sm">
            Try adjusting your filters to see more cards, or clear all filters
            to view the entire board.
          </p>
    ...
    <div className="flex items-center justify-center h-full">
      <Card className="w-full max-w-md mx-auto">
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-sm">
            No cards match your search for &quot;{searchQuery}&quot;. Try a
            different search term or browse all cards.
          </p>
