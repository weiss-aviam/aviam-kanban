...
export const de = {
  ...
  editCard: {
    ...
    deadlineNoteLabel: "Begründung (optional)",
    deadlineNotePlaceholder: "Warum soll der Termin geändert werden?",
    deadlineSubmitSuggestion: "Vorschlag einreichen",
    deadlineCancelSuggestion: "Abbrechen",
    deadlineStatusPending: "Ausstehend",
    deadlineStatusApproved: "Genehmigt",
    deadlineStatusRejected: "Abgelehnt",
    deadlineApproveButton: "Genehmigen",
    deadlineRejectButton: "Ablehnen",
    deadlineBy: "von",
    ...
    deadlineSuggestionSent: "Ihr Vorschlag wurde eingereicht.",
    columnLabel: "Spalte",
