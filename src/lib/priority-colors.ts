...
export function sortCardsByPriority(cards: Card[]): Card[] {
  return [...cards].sort((a, b) => {
    ...
    return (
      PRIORITY_ORDER[priorityA as CardPriority] -
      PRIORITY_ORDER[priorityB as CardPriority]
    );
  });
}
 ...
 */
export function filterCardsByPriority(
  cards: Card[],
 ...
 */
export function getPriorityCSSProperties(
