  ...
  const handleCancelInvitation = async (
    ...
    try {
      const response = await fetch(
        `/api/admin/invitations?id=${invitationId}&boardId=${boardId}`,
        {
          method: "DELETE",
        },
      );
              ...
              {invitation.status === "pending" && (
                <div className="flex space-x-1">
                  <Button
                    ...
                    variant="outline"
                    onClick={() =>
                      handleResendInvitation(invitation.id, invitation.board_id)
                    }
                    disabled={isLoading}
                  >
                    {isLoading ? "..." : "Resend"}
                  ...
                  <Button
                    ...
                    variant="destructive"
                    onClick={() =>
                      handleCancelInvitation(invitation.id, invitation.board_id)
                    }
                    disabled={isLoading}
                  >
                    {isLoading ? "..." : "Cancel"}
